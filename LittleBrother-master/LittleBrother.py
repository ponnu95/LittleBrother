		...
		if choix.lower() == 'h':
			...
			while True:
				...
				if choix.lower() == 'h':
					...
					name = " ".join(name)
					while True:
						print(question+" Do you want to register a Twitter account for this profile?")
						choixPr = input(" [y/n]: " )
						if choixPr.upper() == 'N':
							break
						else:
					...
					while True:
						print(question+" Do you want to register an Instagram account for profile?")
						choixPr = input(" [y/n]: " )
						if choixPr.upper() == 'N':
							break
						else:
							...
							break
					while True:
						print(question+" Do you want to register an Facebook account for profile?")
						choixPr = input(" [y/n]: " )
						if choixPr.upper() == 'N':
							break
						else:
					...
					if create:
						print("\n"+found+" The profile '%s' was created successfully." % (name))
					else:
